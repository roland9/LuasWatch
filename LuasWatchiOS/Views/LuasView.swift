...
struct LuasView: View {
  ...
  fileprivate func foundDueTimesView(for trains: TrainsByDirection, location: CLLocation)
    -> some View
  {
    ZStack {
      VStack {
        ...
        TrainsListView(
          trains: trains, direction: direction ?? .both,
          location: location)
  ...
  @ViewBuilder
  fileprivate func updatingDueTimesView(for trains: TrainsByDirection, location: CLLocation)
    -> some View
  {
    VStack {
      ZStack {
